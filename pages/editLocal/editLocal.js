    ...
    wx.getStorage({
      ...
      success: function (res) {
        ...
        wx.getStorage({
          key: 'localid',
          success: function(res) {
            var localid = res.data;
            wx.request({
              url: getApp().globalData.url + '/index/local/editlocal',
              data: {
                openid: openid,
  ...
  onShow: function () {
    ...
    wx.getStorage({
      ...
      success: function(res) {
        var localid = res.data;
        wx.request({
          url: getApp().globalData.url + '/index/local/getlocal',
          data:{
            localid:localid
          },
          method:'POST',
          ...
          success:function(res){
            ...
            _this.setData({
              sendname:res.data[0].sendname,
              sendphone:res.data[0].sendphone,
              localname:res.data[0].localname
            })
          }
        })
      },
